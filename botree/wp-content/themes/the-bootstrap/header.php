...
<html class="no-js" <?php language_attributes(); ?>>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="http://mywordpress.com/wp-content/themes/the-bootstrap/botree/css/bootstrap.css" />
		<link rel="stylesheet" type="text/css" href="http://mywordpress.com/wp-content/themes/the-bootstrap/botree/css/component.css" />
		<link rel="stylesheet" href="http://fancyapps.com/fancybox/source/jquery.fancybox.css?v=2.1.5" type="text/css" media="screen" />
		<link rel="stylesheet" type="text/css" href="http://mywordpress.com/wp-content/themes/the-bootstrap/botree/css/botree.css" />
			...
			<div id="page" class="hfeed row">
				...
				<header id="branding" role="banner" class="span12">
					...
					<?php if ( get_header_image() ) : ?>
                                    <div id="site-header">
					<a id="" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
